...
void AppendSyntheticItems()
{
    ...
    upsertBoolIntItem(
        ...
        false,
        "Experimental rollback tracer. Enable it on both peers running the same mod build. It records only after a negotiated two-peer start; leave it off for normal play.");
    upsertBoolIntItem(
